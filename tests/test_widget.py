...
@pytest.mark.parametrize("information, expected_result", [("Maestro 1596837868705199", "Maestro 1596 83** **** 5199"),
                                                          ("Счет 64686473678894779589", "Счет **9589"),
                                                          ("MasterCard 7158300734726758", "MasterCard 7158 30** **** 6758"),                                                          ("Счет 35383033474447895560", "Счет **5560"),
                                                          ("Visa Platinum 8990922113665229", 'Visa Platinum 8990 92** **** 5229')]
                         )
def test_mask_account_card(information, expected_result):
